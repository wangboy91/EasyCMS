...
{
    public class LoginLogRepository : Repository<LoginLogEntity>, ILoginLogRepository
    {
        public LoginLogRepository(EfUnitOfWork unitOfWork)
            : base(unitOfWork)
        { }
        ...
        /// <returns></returns>
        public async Task<PagedList<LoginLogEntity>> GetPageList(int pageIndex, int pageSize, string keyword)
        {
