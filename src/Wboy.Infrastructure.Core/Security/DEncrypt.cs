...
namespace Wboy.Infrastructure.Core.Security
{
    ...
    public class DEncrypt
    {
        ...
        private static readonly string Key = "wang91";

        #region 使用 不使用密钥对字符串 加密/解密string
        ...
        /// <returns>密文</returns>
        public static string Base64Encrypt(string original)
        {
        ...
        /// <returns>明文</returns>
        public static string Base64Decrypt(string original)
        {
