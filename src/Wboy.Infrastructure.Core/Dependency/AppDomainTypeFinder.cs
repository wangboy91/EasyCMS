...
namespace Wboy.Infrastructure.Core.Dependency
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        {
            var list = AppDomain.CurrentDomain.GetAssemblies().OrderBy(x => x.FullName).ToList();
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                if (Matches(assembly.FullName))
                {
                    if (!addedAssemblyNames.Contains(assembly.FullName))
                    {
                        ...
                        Trace.TraceInformation("type find FullName:"+assembly.FullName);
                    }
                }
            }
        }
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            //SqlServerTypes.Utilities.LoadNativeAssemblies(directoryPath);
        }
