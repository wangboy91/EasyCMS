        ...
        var dfop =
            {
                 ...
                 */
                cbiconpath: "/js/plugins/tree/images/icons/",
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
                ...
                if ($(et).hasClass("bbit-tree-elbow-plus") || $(et).hasClass("bbit-tree-elbow-end-plus")) {
                    if ($(this).find('i').hasClass('fa fa-folder')) {
                        $(this).find('i').swapClass('fa fa-folder', 'fa fa-folder-open');
                    }
                    ...
                    if ($(this).find('i').hasClass('fa fa-folder-open')) {
                        $(this).find('i').swapClass('fa fa-folder-open', 'fa fa-folder');
                    }
