    ...
    Buttons.prototype.addToolbarButtons = function () {
        ...
        this.context.memo('button.picture', function () {
            return _this.button({
                ...
                click: function () {
                    if (_this.options.callbacks.onInsertImage) {
                        //自定义插入图片回调
                        _this.options.callbacks.onInsertImage();
                    } else {
                        _this.context.createInvokeHandler('imageDialog.show');
                    }
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.createVideoNode = function (url) {
        ...
        $video.css("width","100%").css("height","auto").css("max-height", "420px");
        return $video[0];
    };
